...
public class PinTextInputLayout extends TextInputLayout {
    ...
    public PinTextInputLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PinTextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PinTextInputLayout setHasValidInput(boolean hasValidInput) {
